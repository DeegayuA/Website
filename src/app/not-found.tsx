  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center px-5 text-center">
      <div className="glass glass-sheen max-w-md rounded-3xl px-10 py-14">
        ...
        <Link
          href="/"
          className="glass-button mt-8 inline-flex items-center gap-2 rounded-full bg-accent px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-accent/30"
        >
